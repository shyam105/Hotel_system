<?php $this->load->view('common/header');?>
    ...
    <div class="container ml-5 mt-5">
        <h1 class="page-title left">Delux Room
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Delux Room</h5>
            ...
            <div class="card">    
                <div class="row">
                    <div class="room col-sm-6 col-md-7 mt-3">
                        <a href="<?php echo base_url('public/image/deluxRoom.jpg'); ?>" class="fancybox" data-fancybox-group="hotel">
                            <img src="<?php echo base_url('public/image/deluxRoom.jpg'); ?>" class="img-responsive" alt="Rooms in Yogi Executive" title="Rooms in Yogi Executive">
                        </a>
                    </div>
