            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="<?php echo base_url().'admin/Room/create';?>" class="btn btn-primary"><i class="fas fa-plus" style="margin-right:5px;"></i>create</a>
                    </div>
               </div>
               <div class="card-body">
                            ...
                            <?php if(!empty($room)){?>
                              <?php foreach($room as $room){ ?>
                                <tr>
                                    ...
                                    <td><img src="<?php echo $room['roomimage']?>" style="width: 59px; height: 51px;"><a href="<?php echo $room['roomimage']?>" target="_blank" style="font-size:8px; color:black;"><?php echo $room['imagename']?></a></td>
                                    <td><?php echo $room['price']?></td>
                                    <td><p><?php echo word_limiter(strip_tags($room['roomdetails']), 10);?></p></td>
